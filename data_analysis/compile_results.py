...
for ii in range(rb_over_a_pts):
    ...
    ent_entropies[ii] = np.take_along_axis(ent_entropies[ii], index_array, axis=0)
...
compiled_results = {"rb_over_a_ax": rb_over_a_ax, "delta_over_omega_ax": delta_over_omega_ax, "energies": energies, "entanglement_entropies": ent_entropies, "densities": densities, "ham_config": data_dict["params"]["ham_config"]}
